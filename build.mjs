  ...
  return `<section class="partners-band"><div class="container">
      ...
      <div class="partners-grid">
        ...
        <a class="partner-card" href="https://w3a.foundation" target="_blank" rel="noopener noreferrer" aria-label="Visit W3A, the Web3 Alliance">
          <span class="partner-logo"><svg class="partner-mark-svg" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="5" r="2.3" fill="#fff"/><circle cx="5" cy="18.5" r="2.3" fill="#fff"/><circle cx="19" cy="18.5" r="2.3" fill="#fff"/><path d="M12 5 5 18.5M12 5l7 13.5M5 18.5h14" stroke="#fff" stroke-width="1.3"/></svg><span class="partner-name">W3A</span></span>
